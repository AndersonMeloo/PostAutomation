...
__decorate([
    ...
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], UsersController.prototype, "findAllEmails", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guards_1.AuthGuard),
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guards_1.AuthGuard),
    (0, common_1.Get)(':id/youtube-connection'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "getYoutubeConnection", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guards_1.AuthGuard),
    (0, common_1.Delete)(':id/youtube-connection'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "disconnectYoutube", null);
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guards_1.AuthGuard),
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id')),
